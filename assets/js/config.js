...
const init_phones = ["∆ Headphones.com IEM Diffuse Field HRTF Target", "Crinear Reference"],// Optional. Which graphs to display on initial load. Note: Share URLs will override this set
      ...
      rig_description = "clone IEC 60318-4",            // Optional. Labels the graph with a description of the rig used to make the measurement, e.g. "clone IEC 711"
      page_title = "JSON",                     // Optional. Appended to the page title if share URLs are enabled
...
// this is not being used rn - json
